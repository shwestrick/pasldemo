...
TOOLS_BUILD_FOLDER=/usr0/home/swestric/installs/pasl-edu/tools/build/
...
MODES=opt optfp elision baseline log
...
INCLUDES=. src/ $(SEQUTIL_PATH) $(PARUTIL_PATH) $(SCHED_PATH) $(PBBS_PATH) $(MALLOC_COUNT_PATH) $(QUICKCHECK_PATH)
